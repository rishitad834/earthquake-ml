...
# Ensure the target column is not one-hot encoded
...
# ----------------------------
grid_search = GridSearchCV(dt_model, param_grid, cv=5, scoring='neg_mean_squared_error', verbose=2)
...
plt.title('Binned Confusion Matrix (Decision Tree)')
plt.show()

# Optional: Save the model
# joblib.dump(best_model, 'earthquake_decision_tree_model.pkl')