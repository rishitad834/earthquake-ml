...
class OptimizationComparison:
    ...
    def run_original_random_forest(self):
        """Run original Random Forest with all features"""
        print("\n" + "="*60)
        print("RUNNING ORIGINAL RANDOM FOREST (BASELINE)")
        print("="*60)
        ...
        self.execution_times['Original_RF'] = execution_time
        self.feature_selections['Original_RF'] = list(range(self.X_train.shape[1]))
    ...
    def run_all_comparisons(self):
        ...
        print("4 APPROACHES: Original RF, WOA, PSO, GWO")
        print("#"*80)
        
        # 1. Original Random Forest
        self.run_original_random_forest()
    ...
    def create_comparison_summary(self):
        ...
        baseline_mse = self.results['Original_RF']['MSE']
    ...
    def visualize_comparisons(self, df_comparison):
        ...
        plt.suptitle('Feature Analysis & Algorithm Convergence', fontsize=16, fontweight='bold')
        plt.tight_layout(rect=[0, 0, 1, 0.96])
        plt.show()
        ...
        plt.suptitle('Actual vs Predicted Earthquake Magnitude', fontsize=16, fontweight='bold')
        plt.tight_layout(rect=[0, 0, 1, 0.96])
        plt.show()
    ...
    def save_results(self):
        ...
        # Save models
        for method, results in self.results.items():
            joblib.dump(results['Model'], f'{method.lower()}_optimized_model.pkl')
        
        print("\n" + "="*60)
        print("RESULTS SAVED:")
        print("  • optimization_comparison_results.csv")
        print("  • [algorithm]_selected_features.csv (for WOA, PSO, GWO)")
        print("  • convergence_curves.csv")
        print("  • [method]_optimized_model.pkl (all models)")
        print("="*60)
...
def main():
    ...
    comparison = OptimizationComparison(X_train, X_test, y_train, y_test)
